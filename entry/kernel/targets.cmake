...
function(__collect_targets_from_dir root_dir out_var)
	set(queue ${root_dir})
	set(result)
	while(queue)
		list(POP_FRONT queue d)
		get_property(d_targets DIRECTORY ${d} PROPERTY BUILDSYSTEM_TARGETS)
		if(d_targets)
			list(APPEND result ${d_targets})
		endif()
		get_property(subdirs DIRECTORY ${d} PROPERTY SUBDIRECTORIES)
		if(subdirs)
			list(APPEND queue ${subdirs})
		endif()
	endwhile()
...
function(__redirect_all_targets_output)
    __collect_targets_from_dir(${CMAKE_SOURCE_DIR} __all_targets)
    message(STATUS "__all_targets [[[ ${__all_targets} ]]]")
    foreach(target ${__all_targets})
        __redirect_target_output(${target})
    endforeach()
endfunction()

...
class wxWidgetsConan(ConanFile):
    ...
    def system_requirements(self):
        ...
        if self.options.webview and self.settings.os == "Linux":
    ...
    def generate(self):
        print("debug generate wxwidgets -------> ")
        print(self.options)
        ...
        if self.settings.build_type == "Debug" and self.settings.os == "Windows":
            tc.variables["wxBUILD_DEBUG_LEVEL"] = "2"
        ...
        if self.settings.os != "Windows":
            ...
            tc.variables["wxUSE_WEBVIEW_EDGE"] = "ON"

        tc.variables["wxUSE_LIBPNG"] = "sys"
        tc.variables["wxUSE_LIBJPEG"] = "sys"
        tc.variables["wxUSE_LIBTIFF"] = "OFF"
        ...
        tc.variables["wxUSE_WEBVIEW_IE"] = self.options.webview_ie
